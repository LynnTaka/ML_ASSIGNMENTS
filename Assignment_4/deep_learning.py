...
# FILENAME: deep_learning.oy
# SPECIFICATION: program that will learn how to classify fashion items. You will use
# the dataset Fashion MNIST, which includes 70,000 grayscale images of 28×28 pixels each,
# with 10 classes, each class representing a fashion item as illustrated below. You will
# use Keras to load the dataset which includes 60,000 images for training and 10,000 for
# test. Your goal is to train and test multiple deep neural networks and check their corresponding
# performances, always updating the highest accuracy found. This time you will use a separate
# function named build_model() to define the architectures of your neural networks. Finally,
# the weights of the best model will be printed, together with the architecture and the
# learning curves. To install TensorFlow use: python -m pip install --upgrade tensorflow.
